...
SOLVE_CONDITION = ROWDIM * COLDIM - MINE_COUNT # Average score training will stop at if reached
...
for trial_index in range(NUMBER_OF_TRIALS):
    env.init_gui()
    online_network = create_dqn(0.0005)
    target_network = create_dqn(0.0005) 
